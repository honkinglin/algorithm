    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '283.移动零', link: '/two-pointer/283.md' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '1658.将 x 减到 0 的最小操作数', link: '/sliding-window/1658.md' },
          { text: '1679.K 和数对的最大数目', link: '/sliding-window/1679.md' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '1732.找到最高海拔', link: '/prefix-sum/1732.md' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '2.两数相加', link: '/linked-list/2.md' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: '222.完全二叉树的节点个数', link: '/binary-tree/222.md' },
          { text: '226.翻转二叉树', link: '/binary-tree/226.md' },
          ...
          { text: '437.路径总和 III', link: '/binary-tree/437.md' },
          { text: '450.删除二叉搜索树中的节点', link: '/binary-tree/450.md' },
      ...
      },
      {
        ...
        collapsed: true,
        items: [
          { text: '什么是字符串?', link: '/string/index.md' },
